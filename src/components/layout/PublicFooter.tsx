...
import { Instagram, Twitter, Youtube, Linkedin, Globe, Check } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
const LOCAL_STORAGE_COUNTRY_KEY = 'followups-selected-country-name';
      ...
      <div className="container mx-auto px-[5vw] md:px-[10vw] py-12 md:py-16">
        ...
        <div className="border-t border-slate-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-sm text-slate-400 mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} FollowUps All rights reserved.
          </div>
          <div className="flex space-x-4">
            <a href="https://www.instagram.com/followups.tech/" aria-label="Instagram" className="text-slate-400 hover:text-primary transition-colors"><Instagram size={20} /></a>
            <a href="https://www.linkedin.com/company/followups-tech" aria-label="LinkedIn" className="text-slate-400 hover:text-primary transition-colors"><Linkedin size={20} /></a>
            <a href="https://www.youtube.com/@followups_tech" aria-label="YouTube" className="text-slate-400 hover:text-primary transition-colors"><Youtube size={20} /></a>
            <a href="https://x.com/FollowUp548679" aria-label="Twitter" className="text-slate-400 hover:text-primary transition-colors"><Twitter size={20} /></a>
          </div>
        </div>
      </div>
    </footer>
