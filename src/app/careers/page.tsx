        ...
        <div className="container mx-auto px-[5vw] md:px-[10vw]">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              At FollowUps, we're passionate about empowering professionals to achieve their outreach goals. 
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  <br />
                  <Link href="mailto:followups.socials@gmail.com" className="text-primary font-semibold hover:underline">
                    followups.socials@gmail.com
                  </Link>
                </p>
              </div>

              <div className="pt-4 border-t">
                <h4 className="text-lg font-semibold text-foreground mb-3 font-headline">Why FollowUps?</h4>
