...
const editCompanySchema = z.object({
  ...
  website: z.string().url("Must be a valid URL (e.g., https://example.com)").max(2048, "URL is too long.").optional().or(z.literal('')),
  linkedin_url: z.string().url("Must be a valid LinkedIn URL (e.g., https://linkedin.com/company/name)").max(2048, "URL is too long.").optional().or(z.literal('')),
