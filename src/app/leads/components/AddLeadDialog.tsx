...
import { addLeadSchema, type AddLeadFormValues } from './shared/leadSchemas';
...
export function AddLeadDialog({
  ...
  onAddLead: (values: AddLeadFormValues) => Promise<void>;
  companies: Company[];
  contacts: Contact[];
  ...
  prefillData?: Partial<AddLeadFormValues>;
}) {
  ...
  const { fields: contactFields, append: appendContact, remove: removeContactField, update: updateContact } = useFieldArray({
